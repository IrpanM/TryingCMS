...
<footer class="page-footer">
  <div class="container">
    <div class="row">
      <div class="col l6 s12">
        ...
        kuyya70@gmail.com</p>
        <p class="grey-text text-lighten-4 valign-wrapper"><i class="tiny material-icons">location_city</i> 668 Wiegand Cape</p>
      </div>
  ...
  <div class="footer-copyright">
    <div class="container">&copy; <?php echo Date('Y'); ?> by someone</div>
  </div>
</footer>
